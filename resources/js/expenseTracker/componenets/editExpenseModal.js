...
class EditExpenseModal extends Component {
    ...
    updateExpense = ()=>{
        axios.post('/api/expenses/update/'.concat(this.props.data.id),{
            ...
            this.props.onSave(response.data.expense[0], response.data.success);
        }).catch(error=>{
            try{
                ...
                <Modal show={this.props.show} onHide={() => this.props.onHide()}>
                    ...
                    <Modal.Footer>
                        ...
                        <Button variant="primary"
                                onClick={this.updateExpense}>Submit</Button>
                    </Modal.Footer>
